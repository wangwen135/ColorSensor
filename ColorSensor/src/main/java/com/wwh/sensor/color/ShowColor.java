...
public class ShowColor extends JFrame {
	...
	public ShowColor() {
		...
		contentPane.setLayout(new BorderLayout(0, 0));
				...
				JButton button_2 = new JButton("刷新串口");
				panel_top.add(button_2);
				
				JButton button_3 = new JButton("打开串口");
				panel_top.add(button_3);
				...
				button_1.setBounds(10, 92, 93, 23);
				panel_center.add(button_1);
				
				JPanel panel = new JPanel();
				panel.setBackground(Color.BLACK);
				panel.setBounds(10, 125, 173, 119);
